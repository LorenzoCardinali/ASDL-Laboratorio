...
class TimeSlotTest {
    ...
    final void testOverlapsWith() {
        ...
        GregorianCalendar g5 = new GregorianCalendar(2019, 10, 4, 13, 00);
        GregorianCalendar g6 = new GregorianCalendar(2019, 10, 4, 12, 56);
        GregorianCalendar g7 = new GregorianCalendar(2019, 10, 4, 12, 55);
        GregorianCalendar g8 = new GregorianCalendar(2019, 10, 4, 12, 54);

        // [ ] < >
        assertFalse(ts1.overlapsWith(ts2));
        assertFalse(ts2.overlapsWith(ts1));
        TimeSlot ts3 = new TimeSlot(g5, g4);
        // [ ]< >
        assertFalse(ts1.overlapsWith(ts3));
        assertFalse(ts3.overlapsWith(ts1));
        TimeSlot ts4 = new TimeSlot(g6, g4);
        // [ < 4 min ] >
        assertFalse(ts1.overlapsWith(ts4));
        assertFalse(ts4.overlapsWith(ts1));
        TimeSlot ts5 = new TimeSlot(g7, g4);
        // [ < 5 min ] >
        assertFalse(ts1.overlapsWith(ts5));
        assertFalse(ts5.overlapsWith(ts1));
        TimeSlot ts6 = new TimeSlot(g8, g4);
        // [ < 6 min ] >
        assertTrue(ts1.overlapsWith(ts6));
        assertTrue(ts6.overlapsWith(ts1));

        GregorianCalendar g9 = new GregorianCalendar(2019, 10, 4, 12, 00);

        GregorianCalendar g10 = new GregorianCalendar(2019, 10, 4, 12, 30);
        GregorianCalendar g12 = new GregorianCalendar(2019, 10, 4, 12, 6);
        GregorianCalendar g14 = new GregorianCalendar(2019, 10, 4, 12, 5);

        GregorianCalendar g15 = new GregorianCalendar(2019, 10, 4, 10, 30);

        GregorianCalendar g16 = new GregorianCalendar(2019, 10, 4, 11, 30);
        GregorianCalendar g18 = new GregorianCalendar(2019, 10, 4, 11, 6);
        GregorianCalendar g20 = new GregorianCalendar(2019, 10, 4, 11, 4);
        GregorianCalendar g22 = new GregorianCalendar(2019, 10, 4, 10, 58);

        TimeSlot ts7 = new TimeSlot(g9, g10);
        // [ < 30 min > ]
        assertTrue(ts1.overlapsWith(ts7));
        assertTrue(ts7.overlapsWith(ts1));


        TimeSlot ts8 = new TimeSlot(g9, g12);
        // [ < 6 min > ]
        assertTrue(ts1.overlapsWith(ts8));
        assertTrue(ts8.overlapsWith(ts1));


        TimeSlot ts9 = new TimeSlot(g9, g14);
        // [ < 5 min > ]
        assertFalse(ts1.overlapsWith(ts9));
        assertFalse(ts9.overlapsWith(ts1));


        TimeSlot ts10 = new TimeSlot(g15, g16);
        // < [ 30 min > ]
        assertTrue(ts1.overlapsWith(ts10));
        assertTrue(ts10.overlapsWith(ts1));


        TimeSlot ts11 = new TimeSlot(g15, g18);
        // < [ 6 min > ]
        assertTrue(ts1.overlapsWith(ts11));
        assertTrue(ts11.overlapsWith(ts1));


        TimeSlot ts12 = new TimeSlot(g15, g20);
        // < [ 4 min > ]
        assertFalse(ts1.overlapsWith(ts12));
        assertFalse(ts12.overlapsWith(ts1));


        TimeSlot ts13 = new TimeSlot(g15, g22);
        // < > [ ]
