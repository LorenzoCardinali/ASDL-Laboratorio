...
public abstract class Graph<L> {
     ...
     * Questa operazione è opzionale.
     *
     * @param index1 indice del primo nodo (nodo sorgente in caso di grafo
     *                   orientato)
     * @param index2 indice del secondo nodo (nodo destinazione in caso di
     *                   grafo orientato)
     ...
     * Se il grafo è orientato, i nodi restituiti sono solo quelli collegati da un arco uscente dal nodo passato.
     *
    ...
    /**
     * Restituisce l'insieme di tutti i nodi collegati tramite un arco entrante in un certo nodo in un grafo orientato.
     *
     * @param node il nodo di cui cercare i nodi successori
     *
     * @return l'insieme di tutti i nodi collegati tramite un arco entrante al nodo specificato
     *
     * @throws UnsupportedOperationException se il grafo su cui il metodo è chiamato non è orientato
     *
     * @throws IllegalArgumentException se il nodo passato non esiste
     *
     * @throws NullPointerException se il nodo passato è nullo
    ...
    /**
     * Restituisce l'insieme di tutti gli archi entranti in un certo nodo in un grafo orientato.
     *
