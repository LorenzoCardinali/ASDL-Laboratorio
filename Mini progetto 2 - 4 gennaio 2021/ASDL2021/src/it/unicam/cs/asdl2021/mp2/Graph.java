...
public abstract class Graph<L> {
     ...
     *
     * @return true se il nodo è stato rimosso, false se il nodo non era presente
     *
     * @throws NullPointerException se il nodo passato è null
     *
     * @throws UnsupportedOperationException se l'implementazione del grafo non supporta questa operazione
     */
