...
public interface ObjectiveFunction {
     ...
     * 
     * @param candidates a list of candidate values
     *
     * @return the optimal value among the list of candidates, null if the list of candidates is empty
     *
     ...
     *
     * @return the index of an optimal value among the list of candidates, null if the list of candidates is empty
     *
     * @throws NullPointerException if the list is null
     * 
     */
