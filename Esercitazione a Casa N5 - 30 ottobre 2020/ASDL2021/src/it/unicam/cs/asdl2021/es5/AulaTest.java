...
class AulaTest {
    ...
    /**
     * Test method for {@link it.unicam.cs.asdl2021.es5.Aula#hashCode()}.
     */
    @Test
    ...
    /**
     * Test method for
     * {@link it.unicam.cs.asdl2021.es5.Aula#Aula(java.lang.String, java.lang.String)}.
     */
    @Test
    ...
    /**
     * Test method for
     * {@link it.unicam.cs.asdl2021.es5.Aula#Aula(java.lang.String, java.lang.String, java.util.Set)}.
     */
    @Test
    ...
    /**
     * Test method for
     * {@link it.unicam.cs.asdl2021.es5.Aula#equals(java.lang.Object)}.
     */
    ...
    /**
     * Test method for
     * {@link it.unicam.cs.asdl2021.es5.Aula#compareTo(it.unicam.cs.asdl2021.es5.Aula)}.
     */
    @Test
    ...
    /**
     * Test method for {@link it.unicam.cs.asdl2021.es5.Aula#getFacilities()}.
     */
    @Test
    ...
    /**
     * Test method for {@link it.unicam.cs.asdl2021.es5.Aula#getNome()}.
     */
    @Test
    ...
    /**
     * Test method for {@link it.unicam.cs.asdl2021.es5.Aula#getLocation()}.
     */
    @Test
    ...
    /**
     * Test method for {@link it.unicam.cs.asdl2021.es5.Aula#getPrenotazioni()}.
     */
    @Test
    ...
    /**
     * Test method for
     * {@link it.unicam.cs.asdl2021.es5.Aula#addFacility(it.unicam.cs.asdl2021.es5.Facility)}.
     */
    @Test
    ...
    /**
     * Test method for
     * {@link it.unicam.cs.asdl2021.es5.Aula#isFree(it.unicam.cs.asdl2021.es5.TimeSlot)}.
     */
    @Test
    ...
    /**
     * Test method for
     * {@link it.unicam.cs.asdl2021.es5.Aula#satisfiesFacilities(java.util.Set)}.
     */
    @Test
    ...
    /**
     * Test method for
     * {@link it.unicam.cs.asdl2021.es5.Aula#addPrenotazione(it.unicam.cs.asdl2021.es5.TimeSlot, java.lang.String, java.lang.String)}.
     */
    @Test
    ...
    /**
     * Test method for
     * {@link it.unicam.cs.asdl2021.es5.Aula#removePrenotazione(it.unicam.cs.asdl2021.es5.Prenotazione)}.
     */
    @Test
    ...
    /**
     * Test method for
     * {@link it.unicam.cs.asdl2021.es5.Aula#removePrenotazioniBefore(java.util.GregorianCalendar)}.
     */
    @Test
    final void testRemovePrenotazioniBefore() {
        Aula a = new Aula("LA1", "Polo Lodovici Piano Terra");
        assertThrows(NullPointerException.class, () -> a.removePrenotazioniBefore(null));
        ...
        for (int anno = 2019; anno <= 2019; anno++)
            for (int mese = 0; mese <= 11; mese++)
                for (int giorno = 1; giorno <= 28; giorno++)
                    for (int ora = 8; ora <= 16; ora += 2) {
                        TimeSlot ts = new TimeSlot(
                                new GregorianCalendar(anno, mese, giorno, ora, 0),
                                new GregorianCalendar(anno, mese, giorno, ora + 2, 0));
                        a.addPrenotazione(ts, "LT", "Pippo");
                    }
        // Controlla che venga usato l'ordinamento tra le prenotazioni per
        ...
        assertTimeout(ofMillis(10), () -> { a.removePrenotazioniBefore(new GregorianCalendar(2019, 0, 1, 16, 00)); });
        assertTrue(a.isFree(new TimeSlot(new GregorianCalendar(2019, 0, 1, 8, 0), new GregorianCalendar(2019, 0, 1, 18, 0))));
        assertFalse(a.isFree(new TimeSlot(new GregorianCalendar(2019, 0, 2, 8, 0),
                        new GregorianCalendar(2019, 0, 2, 10, 0))));
        assertFalse(a.isFree(new TimeSlot(new GregorianCalendar(2019, 0, 2, 10, 0),
                        new GregorianCalendar(2019, 0, 2, 12, 0))));
        assertFalse(a.removePrenotazioniBefore(new GregorianCalendar(2019, 0, 1, 16, 00)));
    }
